...
{
    int level;
    static const int support[DWT_NUM_TYPES] = {
        [DWT_DIRAC_DD9_7]     = 7,
        [DWT_DIRAC_LEGALL5_3] = 3,
        [DWT_DIRAC_DD13_7]    = 7,
        [DWT_DIRAC_HAAR0]     = 1,
        [DWT_DIRAC_HAAR1]     = 1,
        [DWT_DIRAC_DAUB9_7]   = 5,
                      ...
                      int stride, enum dwt_type type, int decomposition_count)
{
    ...
    ff_spatial_idwt_init2(&d, buffer, width, height, stride, type, decomposition_count);
